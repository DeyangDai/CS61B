...
public class SList<T> extends List<T> {
	 ...
	 **/
	protected SListNode<T> newNode(T item, SListNode<T> next) {
		return new SListNode<T>(item, this, next);
	}
	...
	public ListNode<T> front() {
		if (head == null) {
			...
			SListNode<T> node = newNode(null, null);
			node.myList = null;
			return node;
		} else {
			return head;
	...
	private static void testEmpty() {
		List<Integer> l = new SList<Integer>();
