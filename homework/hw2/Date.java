...
class Date {
  ...
  public boolean isAfter(Date d) {
    return this.totalDays() > d.totalDays();                        // replace this line with your solution
  }
  ...
  public int dayInYear() {
	...
	for(int i = 1; i < month; i++){
		totalDaysInYear += daysInMonth(i, year);
	}
	totalDaysInYear += day;
  ...
  public static void main(String[] argv) {
	...
	Date d6 = new Date("8/31/6");
	Date d7 = new Date("8/30/6");
	Date d8 = new Date("9/1/6");
	...
	System.out.println(d6 + " - " + d7  + " should be 1: " + 
                       d6.difference(d7));
	System.out.println(d6 + " - " + d8  + " should be -1: " + 
                       d6.difference(d8));	
	System.out.println(d8 + " - " + d6  + " should be 1: " + 
                       d8.difference(d6));					   
  }
}